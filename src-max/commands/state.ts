...
export const textState = new Map<
  number,
  'broadcasts' | 'new_broadcast' | 'battery_request' | 'select_battery' | 'create_warranty'
>();

export const createWarrantySteps = new Map<number, { promptMid: string; commandMid: string }>();
